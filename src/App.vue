        ...
        <li v-for="item in filteredJokes" :key="item" class="joke__item">
          ...
          <button @click="setLikes" class="btn-reset joke__btn">
            ...
            >
              ...
              <path
                style="fill: #01579b"
                d="M160,501.333H10.667C4.776,501.333,0,496.558,0,490.667v-256C0,228.776,4.776,224,10.667,224H160
                c5.891,0,10.667,4.776,10.667,10.667v256C170.667,496.558,165.891,501.333,160,501.333z M21.333,480h128V245.333h-128V480z"
              />
              <path
                class="path-bg"
                d="M160,448c18.59,13.606,40.965,21.064,64,21.333h197.333c20.571,0.072,37.306-16.546,37.378-37.118
              ...
              <path
                style="fill: #01579b"
                d="M421.333,480H224c-25.865-0.206-50.969-8.783-71.552-24.448c-1.999-2.004-3.12-4.721-3.115-7.552V256
...
export default {
  ...
  methods: {
    setLikes(evt) {
      evt.target.closest(".joke__item").classList.toggle("joke__item--bg");
      evt.target
        .closest(".svg")
